  ...
  const handleEnablePush = async () => {
    if (!user) {
      toast({
        ...
        description: 'Push notifications enable karne ke liye pehle sign in karein.',
        variant: 'destructive',
      });
      return;
    }
    ...
    <div className="min-h-screen bg-background p-4 pb-24">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="text-center space-y-2">
          <img src={appLogo} alt="Expense Manager" className="w-20 h-20 mx-auto rounded-2xl shadow-lg" />
        ...
        {isSupported && (
          <Card className="border-primary/20">
            <CardContent className="p-5 space-y-4">
              ...
              {!user ? (
                <div className="text-xs text-muted-foreground">
                  Push notifications enable karne ke liye pehle login karein.
                </div>
              ) : isSubscribed ? (
                <div className="flex items-center gap-2 text-primary text-sm">
                  <CheckCircle2 className="h-4 w-4" />
